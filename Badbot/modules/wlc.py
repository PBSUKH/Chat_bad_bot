...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    background = Image.open("Badbot/font/wel2.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp, brightness_factor=brightness_factor) 
    pfp = pfp.resize((575, 575))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('Badbot/font/font.ttf', size=70)
    welcome_font = ImageFont.truetype('Badbot/font/font.ttf', size=61)
...
@app.on_message(filters.command("shizuwlc") & ~filters.private)
